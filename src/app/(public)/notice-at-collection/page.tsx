...
export default function NoticeAtCollectionPage() {
  return (
    <LegalDocument title="Notice at Collection" description="A short notice about the information collected when you create an account or use PerfectPPI.">
      ...
      <p>PerfectPPI does not currently sell personal information for money or use cross-context behavioral advertising. Information is retained only as reasonably needed for the disclosed purposes, security, disputes, contracts, and legal obligations. Final category-specific retention periods are pending documented business-owner and legal approval.</p>
