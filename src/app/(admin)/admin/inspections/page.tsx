  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            {total.toLocaleString()} inspection{total !== 1 ? "s" : ""} total
            {hasFilters && " · Filtered"}
          </p>
        </div>
      </div>
      ...
      <form action="/admin/inspections" method="GET" className="flex flex-wrap gap-3 items-end">
        ...
        <div>
          <p className="text-xs font-bold text-muted-foreground mb-1">PPI Type</p>
          <select
            name="ppiType"
          ...
          >
            ...
            <option value="certified_tech">Certified Tech</option>
          </select>
        </div>
            ...
            {submissions.length === 0 ? (
              <tr>
                <td colSpan={7} className="px-4 py-10 text-center text-muted-foreground">
                  {hasFilters ? "No inspections match your filters." : "No inspections yet."}
                </td>
              </tr>
            ) : (
              submissions.map((sub) => {
                  ...
                  <tr key={sub.id} className="hover:bg-muted/30">
                    ...
                    <td className="px-4 py-3">
                      {performer ? (
                        ...
                        <span className="text-muted-foreground italic text-xs">Self</span>
                      )}
                    </td>
                    <td className="px-4 py-3">
