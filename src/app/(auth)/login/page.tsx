  ...
  return (
    <>
      <header className="mb-10">
        <h2 className="text-3xl font-heading font-extrabold text-on-surface tracking-tight mb-2">{uiText("ui.welcome_back_0c3310a647")}</h2>
        <p className="text-on-secondary-container font-medium">{uiText("ui.enter_your_credentials_to_access_your_accoun_301f175134")}</p>
      </header>
        ...
        <form action={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center px-1">
              ...
              >{uiText("ui.need_help_c225cdfb75")}</Link>
            </div>
            <div className="relative">
              <input
                id="password"
          ...
          >
            {loading ? uiText("ui.signing_in_1f96f5d016") : uiText("ui.sign_in_bcc0bcc914")}
          </button>
        </form>
      </div>

      <footer className="mt-12 text-center">
        <p className="text-on-secondary-container font-medium">{uiText("ui.don_t_have_an_account_1b545b23fa")}{" "}
          <Link
            href="/signup"
            className="text-on-tertiary-container font-bold hover:underline"
          >{uiText("ui.create_account_0dffe234b4")}</Link>
        </p>
